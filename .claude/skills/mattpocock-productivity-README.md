...
- **[mattpocock-teach](./mattpocock-teach/SKILL.md)** — Teach the user a new skill or concept over multiple sessions, using the current directory as a stateful teaching workspace. (Renamed from upstream `teach` to avoid clashing with the built-in `teach` skill.)
